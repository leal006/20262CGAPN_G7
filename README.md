README
Portfólio Técnico — Grupo 7
Disciplina: Análise de Dados para Pesquisas em Políticas Públicas (CGAPN)
...
Planilha de análise dos Microdados do Censo Escolar da Educação Básica 2024, com tratamento de variáveis, tabelas dinâmicas, gráficos dinâmicos, segmentação e dashboard.
Observação
Cada projeto possui um README próprio com objetivo, instruções de uso, fonte dos dados, registro do uso de inteligência artificial e participação do grupo.
